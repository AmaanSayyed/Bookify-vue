    ...
    <div  class=" max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl my-4">
        ...
        <div class="flex  px-8 pb-4">
            <div>
                ...
                <button type="button" class="btn py-1.4"  @click="editBook(book,index)">Edit </button>
            </div>
            <div>
                <button type="button" class="btn py-1.4" @click="deleteBook(index)" >Delete</button>
            </div>
        </div>
    </div>
</div>
...
<style >
.btn{
    @apply items-center min-w-14 ring-1 ring-black rounded px-2  bg-purple-50 hover:bg-purple-100 me-4
}
</style>
